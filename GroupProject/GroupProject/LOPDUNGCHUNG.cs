...
namespace GroupProject
{
    ...
    {
        SqlConnection conn;
        string path = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\GroupProject\GroupProject\GroupProject\App_Data\PETSHOP.mdf;Integrated Security=True";
        ...
        private void connect()
        {
            ...
            conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\GroupProject\GroupProject\GroupProject\App_Data\PETSHOP.mdf;Integrated Security=True");
            conn.Open();
        }
